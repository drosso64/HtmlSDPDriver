...
public class SAPFilterDestroyRes extends SAPMessage {



	public static final int  MSG_TYPE = 235;
...

	{
		...
		SapFilterDestroyOK(0),

		SapFilterDestroyInvalidFilterKey(1);
	...
	protected Result result = Result.SapFilterDestroyOK;



	public SAPFilterDestroyRes(SAPHeader sapHeader) {
	...
	public int writeXDR(XDRByteBuffer byteBuff) throws Exception {
		...
		throw new Exception("SAPFilterDestroyRes can be only read from client side");
