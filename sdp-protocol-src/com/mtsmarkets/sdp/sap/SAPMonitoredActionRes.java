...
public class SAPMonitoredActionRes extends SAPMessage {



	public static final int  MSG_TYPE = 216;
	...
	protected ULong inTimeStamp = new ULong(0);

	protected ULong outTimeStamp = new ULong(0);
	...
	public SAPMonitoredActionRes(SAPHeader sapHeader, MarketFactory mktFactory) {
		super(sapHeader);
    ...
    public void readBodyXDR(XDRByteBuffer byteBuff) throws Exception {
        ...
        inTimeStamp.setValue(byteBuff.readInt());
        outTimeStamp.setValue(byteBuff.readInt());
        ...
        if (resClassId.getValue() != 0) {
            ...
            try {
                ...
                String msg = e + "SAPMonitoredActionRes::readBodyXDR xdr error<" + e.getMessage() + "> decoding smpMessage in " + toString()
	...
	public int writeXDR(XDRByteBuffer byteBuff) throws Exception {
		...
		throw new Exception("SAPMonitoredActionRes can only read from client side");
...

	{
		...
		.append("InTimeStamp(").append(inTimeStamp.getValue()).append(")")

		.append("OutTimeStamp(").append(outTimeStamp.getValue()).append(")")
	...
	public void setInTimeStamp(ULong inTimeStamp) {
	...
	public void setOutTimeStamp(ULong outTimeStamp) {
