...
public class SAPMonitoredActionReq extends SAPMessage {

	

	public static final int MSG_TYPE = 215;
	...
	private int dataInResponse = 0;
	protected SMPMessage smpMessage = null;
    private MarketFactory mktFactory;


	public SAPMonitoredActionReq(SMPMessage smpMessage) {
    ...
    public SAPMonitoredActionReq(SAPHeader sapHeader, MarketFactory mktFactory) {
		super(sapHeader);
