...
public class BV_HIST_SELL_SIDE_INVENTORY_ORDER_QUERY_PARAM extends SMPMessage
{
	public static final long CLASS_ID = 214210;
	...
	private TI_QUERY_OP_Enum DealerReferenceIdOp = TI_QUERY_OP_Enum.TI_QUERY_OP_None;
	...
	public BV_HIST_SELL_SIDE_INVENTORY_ORDER_QUERY_PARAM()
	{
	}
	...
	public TI_QUERY_OP_Enum getDealerReferenceIdOp()
	{
		return DealerReferenceIdOp;
	}
	public void setDealerReferenceIdOp(TI_QUERY_OP_Enum value)
	{
		DealerReferenceIdOp = value;
	}
	...
	public void readXDR(XDRByteBuffer byteBuffer) throws Exception
	{
		...
		DealerReferenceIdOp = DealerReferenceIdOp.getEnum(byteBuffer.readInt());
	...
	public int writeXDR(XDRByteBuffer byteBuffer) throws Exception
	{
		...
		byteBuffer.writeInt(DealerReferenceIdOp.getValue());
	...
	public String toString()
	{
		...
		stringBuilder.append("BV_HIST_SELL_SIDE_INVENTORY_ORDER_QUERY_PARAM::");
		...
		stringBuilder.append("DealerReferenceIdOp(").append(DealerReferenceIdOp).append(")");
