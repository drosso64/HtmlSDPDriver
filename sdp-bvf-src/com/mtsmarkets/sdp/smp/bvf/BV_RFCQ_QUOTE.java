...
public class BV_RFCQ_QUOTE extends SMPMessage
{
	public static final long CLASS_ID = 114167;
	...
	private BV_RFCQ_QUOTING_LEG[] QuotingLeg = new BV_RFCQ_QUOTING_LEG[3];
	...
	public BV_RFCQ_QUOTE()
	{
		for (int i=0; i < QuotingLeg.length; ++i)
		{
			QuotingLeg[i] = new BV_RFCQ_QUOTING_LEG();
		}
	}
	...
	public BV_RFCQ_QUOTING_LEG[] getQuotingLeg()
	{
		return QuotingLeg;
	}
	public void setQuotingLeg(BV_RFCQ_QUOTING_LEG[] value)
	{
		QuotingLeg = value;
	}
	...
	public String toString()
	{
		...
		stringBuilder.append("BV_RFCQ_QUOTE::");
