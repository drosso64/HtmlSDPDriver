...
public class BV_VOICE_CONFIRMED_QUOTES_REGISTRATION extends SMPMessage
{
	public static final long CLASS_ID = 400029;
	...
	private BV_VOICE_CONFIRMED_QUOTES[] Quotes = new BV_VOICE_CONFIRMED_QUOTES[20];
	...
	public BV_VOICE_CONFIRMED_QUOTES_REGISTRATION()
	{
		for (int i=0; i < Quotes.length; ++i)
		{
			Quotes[i] = new BV_VOICE_CONFIRMED_QUOTES();
		}
	}
	...
	public BV_VOICE_CONFIRMED_QUOTES[] getQuotes()
	{
		return Quotes;
	}
	public void setQuotes(BV_VOICE_CONFIRMED_QUOTES[] value)
	{
		Quotes = value;
	}
	...
	public String toString()
	{
		...
		stringBuilder.append("BV_VOICE_CONFIRMED_QUOTES_REGISTRATION::");
