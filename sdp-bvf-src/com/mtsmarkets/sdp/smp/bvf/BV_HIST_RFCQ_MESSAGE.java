...
public class BV_HIST_RFCQ_MESSAGE extends SMPMessage
{
	public static final long CLASS_ID = 114296;

	private long Date = 0;
	private TI_MSG_INFO RfcqMsgInfo = new TI_MSG_INFO();
	private BV_HIST_MEMBER_INFO TraderInfo = new BV_HIST_MEMBER_INFO();
	private BV_HIST_MEMBER_INFO AddresseeMemberInfo = new BV_HIST_MEMBER_INFO();
	...
	public BV_HIST_MEMBER_INFO getTraderInfo()
	{
		return TraderInfo;
	}
	public void setTraderInfo(BV_HIST_MEMBER_INFO value)
	{
		TraderInfo = value;
	}
	public BV_HIST_MEMBER_INFO getAddresseeMemberInfo()
	{
		return AddresseeMemberInfo;
	}
	public void setAddresseeMemberInfo(BV_HIST_MEMBER_INFO value)
	{
	...
	public String toString()
	{
		...
		stringBuilder.append("BV_HIST_RFCQ_MESSAGE::");
