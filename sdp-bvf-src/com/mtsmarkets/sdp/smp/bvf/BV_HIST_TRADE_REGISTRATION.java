...
public class BV_HIST_TRADE_REGISTRATION extends SMPMessage
{
	public static final long CLASS_ID = 400067;
	...
	private BV_TRADE_REGISTRATION_LEG_INFO Leg = new BV_TRADE_REGISTRATION_LEG_INFO();
	...
	public BV_HIST_TRADE_REGISTRATION()
	{
	}
	...
	public BV_TRADE_REGISTRATION_LEG_INFO getLeg()
	{
		return Leg;
	}
	public void setLeg(BV_TRADE_REGISTRATION_LEG_INFO value)
	{
		Leg = value;
	}
	...
	public String toString()
	{
		...
		stringBuilder.append("BV_HIST_TRADE_REGISTRATION::");
		...
		stringBuilder.append("Leg(").append(Leg.toString()).append(")");
