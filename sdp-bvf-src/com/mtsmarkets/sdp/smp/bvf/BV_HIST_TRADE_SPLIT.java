...
public class BV_HIST_TRADE_SPLIT extends SMPMessage
{
	public static final long CLASS_ID = 114307;

	private BV_HIST_MEMBER_INFO Member = new BV_HIST_MEMBER_INFO();
	...
	private String WorkingTraderName = "";
	...
	private BV_HIST_SPLIT_ACCOUNT_INFO[] AccountInfo = new BV_HIST_SPLIT_ACCOUNT_INFO[100];
	...
	public BV_HIST_TRADE_SPLIT()
	{
		for (int i=0; i < AccountInfo.length; ++i)
		{
			AccountInfo[i] = new BV_HIST_SPLIT_ACCOUNT_INFO();
		}
	}

	public BV_HIST_MEMBER_INFO getMember()
	{
		return Member;
	}
	public void setMember(BV_HIST_MEMBER_INFO value)
	{
		Member = value;
	}
	...
	public String getWorkingTraderName()
	{
		return WorkingTraderName;
	}
	public void setWorkingTraderName(String value)
	{
		WorkingTraderName = value;
	}
	...
	public BV_HIST_SPLIT_ACCOUNT_INFO[] getAccountInfo()
	{
		return AccountInfo;
	}
	public void setAccountInfo(BV_HIST_SPLIT_ACCOUNT_INFO[] value)
	{
		AccountInfo = value;
	}
	...
	public void readXDR(XDRByteBuffer byteBuffer) throws Exception
	{
		...
		WorkingTraderName = byteBuffer.readString();
	...
	public int writeXDR(XDRByteBuffer byteBuffer) throws Exception
	{
		...
		byteBuffer.writeString(WorkingTraderName);
	...
	public String toString()
	{
		...
		stringBuilder.append("BV_HIST_TRADE_SPLIT::");
		...
		stringBuilder.append("WorkingTraderName(").append(WorkingTraderName).append(")");
