...
public class BV_HIST_RFCQ_SELL_SIDE_SUMMARY extends SMPMessage
{
	public static final long CLASS_ID = 114283;

	private BV_HIST_RFCQ_SELL_SIDE_SUMMARY_INFO Summary = new BV_HIST_RFCQ_SELL_SIDE_SUMMARY_INFO();

	public BV_HIST_RFCQ_SELL_SIDE_SUMMARY()
	{
	}
	...
	public String toString()
	{
		...
		stringBuilder.append("BV_HIST_RFCQ_SELL_SIDE_SUMMARY::");
