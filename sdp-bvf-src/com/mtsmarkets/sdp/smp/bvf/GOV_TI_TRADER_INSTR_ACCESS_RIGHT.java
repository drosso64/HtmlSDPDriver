...
public class GOV_TI_TRADER_INSTR_ACCESS_RIGHT extends SMPMessage
{
	public static final long CLASS_ID = 100851;

	private TI_TRADER_INSTR_ACCESS_RIGHT Info = new TI_TRADER_INSTR_ACCESS_RIGHT();
	private TI_FLAG_Enum PendingFg = TI_FLAG_Enum.TI_FLAG_No;

	public GOV_TI_TRADER_INSTR_ACCESS_RIGHT()
	{
	}

	public TI_TRADER_INSTR_ACCESS_RIGHT getInfo()
	{
		return Info;
	}
	public void setInfo(TI_TRADER_INSTR_ACCESS_RIGHT value)
	{
		Info = value;
	}
	...
	public String toString()
	{
		...
		stringBuilder.append("GOV_TI_TRADER_INSTR_ACCESS_RIGHT::");
