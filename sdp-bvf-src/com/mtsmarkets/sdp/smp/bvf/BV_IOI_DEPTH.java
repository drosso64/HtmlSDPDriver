...
public class BV_IOI_DEPTH extends SMPMessage
{
	public static final long CLASS_ID = 400012;

	private long MemberId = 0;
	private BV_INSTRUMENT_INFO Instrument = new BV_INSTRUMENT_INFO();
	private long SectionId = 0;
	private BV_IOI_TRADING_INFO[] Bid = new BV_IOI_TRADING_INFO[30];
	private BV_IOI_TRADING_INFO[] Ask = new BV_IOI_TRADING_INFO[30];
	...
	public BV_IOI_DEPTH()
	{
		...
		{
			Bid[i] = new BV_IOI_TRADING_INFO();
		}
		for (int i=0; i < Ask.length; ++i)
		{
			Ask[i] = new BV_IOI_TRADING_INFO();
		}
	}
	...
	public BV_IOI_TRADING_INFO[] getBid()
	{
		return Bid;
	}
	public void setBid(BV_IOI_TRADING_INFO[] value)
	{
		Bid = value;
	}
	public BV_IOI_TRADING_INFO[] getAsk()
	{
		return Ask;
	}
	public void setAsk(BV_IOI_TRADING_INFO[] value)
	{
		Ask = value;
	}
	...
	public String toString()
	{
		...
		stringBuilder.append("BV_IOI_DEPTH::");
