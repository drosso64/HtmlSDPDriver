...
public class BV_CUTOFF extends SMPMessage
{
	public static final long CLASS_ID = 114301;

	private String CutoffDescr = "";
	...
	public String getCutoffDescr()
	{
		return CutoffDescr;
	}
	public void setCutoffDescr(String value)
	{
		CutoffDescr = value;
	}
	...
	{
		CutoffDescr = byteBuffer.readString();
	...
	public int writeXDR(XDRByteBuffer byteBuffer) throws Exception
	{
		...
		byteBuffer.writeString(CutoffDescr);
	...
	public String toString()
	{
		...
		stringBuilder.append("BV_CUTOFF::");
		stringBuilder.append("CutoffDescr(").append(CutoffDescr).append(")");
