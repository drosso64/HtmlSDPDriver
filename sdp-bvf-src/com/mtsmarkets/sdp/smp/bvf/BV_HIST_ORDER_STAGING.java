...
public class BV_HIST_ORDER_STAGING extends SMPMessage
{
	public static final long CLASS_ID = 114299;
	...
	private BV_HIST_ORDER_STAGING_DEALER_INFO[] DealerList = new BV_HIST_ORDER_STAGING_DEALER_INFO[50];
	...
	public BV_HIST_ORDER_STAGING()
	{
		for (int i=0; i < DealerList.length; ++i)
		{
			DealerList[i] = new BV_HIST_ORDER_STAGING_DEALER_INFO();
		}
	}
	...
	public BV_HIST_ORDER_STAGING_DEALER_INFO[] getDealerList()
	{
		return DealerList;
	}
	public void setDealerList(BV_HIST_ORDER_STAGING_DEALER_INFO[] value)
	{
		DealerList = value;
	}
	...
	public String toString()
	{
		...
		stringBuilder.append("BV_HIST_ORDER_STAGING::");
