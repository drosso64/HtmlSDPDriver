...
public class BV_PORTFOLIO_RFCQ_ORDER extends SMPMessage
{
	public static final long CLASS_ID = 400083;
	...
	private BV_PORTFOLIO_RFCQ_ORDER_LEG[] OrderLeg = new BV_PORTFOLIO_RFCQ_ORDER_LEG[200];
	...
	public BV_PORTFOLIO_RFCQ_ORDER()
	{
		for (int i=0; i < OrderLeg.length; ++i)
		{
			OrderLeg[i] = new BV_PORTFOLIO_RFCQ_ORDER_LEG();
		}
	}
	...
	public BV_PORTFOLIO_RFCQ_ORDER_LEG[] getOrderLeg()
	{
		return OrderLeg;
	}
	public void setOrderLeg(BV_PORTFOLIO_RFCQ_ORDER_LEG[] value)
	{
		OrderLeg = value;
	}
	...
	public String toString()
	{
		...
		stringBuilder.append("BV_PORTFOLIO_RFCQ_ORDER::");
