...
public class BV_HIST_TRADE_SALES_DEFINITION extends SMPMessage
{
	public static final long CLASS_ID = 400107;

	private BV_TRADE_SALES_DEFINITION Trade = new BV_TRADE_SALES_DEFINITION();

	public BV_HIST_TRADE_SALES_DEFINITION()
	{
	}
	...
	public String toString()
	{
		...
		stringBuilder.append("BV_HIST_TRADE_SALES_DEFINITION::");
