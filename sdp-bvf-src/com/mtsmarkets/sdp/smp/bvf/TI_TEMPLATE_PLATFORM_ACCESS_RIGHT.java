...
public class TI_TEMPLATE_PLATFORM_ACCESS_RIGHT extends SMPMessage
{
	public static final long CLASS_ID = 100233;

	private TI_TRADER_TYPE_Enum TraderType = TI_TRADER_TYPE_Enum.TI_TRADER_TYPE_Manager;
	private TI_PLATFORM_CLASS_TYPE_Enum ClassType = TI_PLATFORM_CLASS_TYPE_Enum.TI_PLATFORM_CLASS_TYPE_All;
	private TI_ACCESS_RIGHT_Enum TraderProfile = TI_ACCESS_RIGHT_Enum.TI_ACCESS_RIGHT_None;

	public TI_TEMPLATE_PLATFORM_ACCESS_RIGHT()
	{
	}
	...
	public TI_PLATFORM_CLASS_TYPE_Enum getClassType()
	{
		return ClassType;
	}
	public void setClassType(TI_PLATFORM_CLASS_TYPE_Enum value)
	{
		ClassType = value;
	}
	...
	public String toString()
	{
		...
		stringBuilder.append("TI_TEMPLATE_PLATFORM_ACCESS_RIGHT::");
