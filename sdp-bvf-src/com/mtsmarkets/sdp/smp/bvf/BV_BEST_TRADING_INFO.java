...
public class BV_BEST_TRADING_INFO extends SMPMessage
{
	public static final long CLASS_ID = 114932;
	...
	private BV_BEST_TRADING_INFO_TYPE_Enum QuotationType = BV_BEST_TRADING_INFO_TYPE_Enum.BV_BEST_TRADING_INFO_TYPE_None;

	public BV_BEST_TRADING_INFO()
	{
	}
	...
	public BV_BEST_TRADING_INFO_TYPE_Enum getQuotationType()
	{
		return QuotationType;
	}
	public void setQuotationType(BV_BEST_TRADING_INFO_TYPE_Enum value)
	{
		QuotationType = value;
	}
	...
	public void readXDR(XDRByteBuffer byteBuffer) throws Exception
	{
		...
		QuotationType = QuotationType.getEnum(byteBuffer.readInt());
	}
	@Override
	public int writeXDR(XDRByteBuffer byteBuffer) throws Exception
	{
		...
		byteBuffer.writeInt(QuotationType.getValue());
	...
	public String toString()
	{
		...
		stringBuilder.append("BV_BEST_TRADING_INFO::");
		...
		stringBuilder.append("QuotationType(").append(QuotationType).append(")");
