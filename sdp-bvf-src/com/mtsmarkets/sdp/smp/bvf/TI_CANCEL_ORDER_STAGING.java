...
public class TI_CANCEL_ORDER_STAGING extends SMPMessage
{
	public static final long CLASS_ID = 100809;
	...
	public TI_CANCEL_ORDER_STAGING()
	{
	}
	...
	{
		OrderId = (long)byteBuffer.readInt();
	...
	public int writeXDR(XDRByteBuffer byteBuffer) throws Exception
	{
		...
		byteBuffer.writeInt((int)(OrderId & 0xFFFFFFFFL));
	...
	public String toString()
	{
		...
		stringBuilder.append("TI_CANCEL_ORDER_STAGING::");
